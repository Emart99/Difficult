...
@EnableRedisRepositories(basePackages = {"com.main.Difficult.Repositories.redis"})

public class DifficultApplication {
	public static void main(String[] args) {SpringApplication.run(DifficultApplication.class, args);}
}
